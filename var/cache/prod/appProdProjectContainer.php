...
class appProdProjectContainer extends Container
{
     ...
     *
     * @return \AppBundle\Rpc\AcmeRpc A AppBundle\Rpc\AcmeRpc instance
     */
    protected function getAcmeHello_RpcSampleServiceService()
    {
        return $this->services['acme_hello.rpc_sample_service'] = new \AppBundle\Rpc\AcmeRpc();
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Topic\AcmeTopic A AppBundle\Topic\AcmeTopic instance
     */
    protected function getAcmeHello_TopicSampleServiceService()
    {
        return $this->services['acme_hello.topic_sample_service'] = new \AppBundle\Topic\AcmeTopic();
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('dGiHQl8GUg', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('glrjg-JFZL', 0, 'Jcd6VecClPnuOAF2FI9QlL', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'testproject', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_95bc796107402e11f4621063eea6f1506f661435ceed39d5725fc355adbfd9ba');
    ...
    protected function getGosPubsubRouter_Loader_WebsocketService()
    {
        ...
        $instance->addResource('@AppBundle/Resources/config/pubsub/routing.yml');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Gos\Bundle\WebSocketBundle\Pusher\Amqp\AmqpPusher A Gos\Bundle\WebSocketBundle\Pusher\Amqp\AmqpPusher instance
     */
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Gos\Bundle\WebSocketBundle\Pusher\Zmq\ZmqPusher A Gos\Bundle\WebSocketBundle\Pusher\Zmq\ZmqPusher instance
     */
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('jj9bS7idBD', NULL, 'Jcd6VecClPnuOAF2FI9QlL', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uHipaZtoE-', 0, 'Jcd6VecClPnuOAF2FI9QlL', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uK0Fq89T31', 0, 'Jcd6VecClPnuOAF2FI9QlL', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('590e39d49d3a50.95426492')), true);
